	...
	const header = (
		<Container>
			<div className={`bg-white`}>
				<div className={`max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 h-whole`}>
					<div className={`text-left`}>
						<h2 className={`text-base font-semibold text-lighterBlack tracking-wide uppercase underline`}>Web applications</h2>
